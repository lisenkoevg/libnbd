...
# Check the --allocated + --destination-is-zero options without --synchronous.
...
inp=copy-allocated-destination-zero-asynch.in
out=copy-allocated-destination-zero-asynch.out
...
$VG nbdcopy --allocated --destination-is-zero --request-size=32K $inp $out
